            ...
            <div class="row">
              <div class="col-lg-6 col-md-6">
                <div class="mu-about-us-left">
                  ...
                  <!-- End Title -->
                  <p><?php echo $basic[0]['about_us'];?></p>
                </div>
              </div>
              <div class="col-lg-6 col-md-6">
                <div class="mu-about-us-right">                            
                <a id="mu-abtus-video" href="#" target="mutube-video">
                  <img src="<?=base_url('assets/img/about-us.jpg');?>" alt="img">
                </a>                
                </div>
              </div>
            </div>
          ...
          <div class="mu-latest-courses-area">
            ...
            <div id="mu-latest-course-slide" class="mu-latest-courses-content">
              <div class="col-lg-4 col-md-4 col-xs-12">
                <div class="mu-latest-course-single">
                  <figure class="mu-latest-course-img">
                    <a href="#"><img src="<?=base_url('assets/img/courses/1.jpg');?>" alt="img"></a>
              ...
              <div class="col-lg-4 col-md-4 col-xs-12">
                <div class="mu-latest-course-single">
                  <figure class="mu-latest-course-img">
                    <a href="#"><img src="<?=base_url('assets/img/courses/2.jpg');?>" alt="img"></a>
                    <figcaption class="mu-latest-course-imgcaption">
              ...
              <div class="col-lg-4 col-md-4 col-xs-12">
                <div class="mu-latest-course-single">
                  <figure class="mu-latest-course-img">
                    <a href="#"><img src="<?=base_url('assets/img/courses/3.jpg');?>" alt="img"></a>
                    <figcaption class="mu-latest-course-imgcaption">
                      <a href="#">Academic</a>
                      <span><i class="fa fa-clock-o"></i>45Days</span>
                    </figcaption>
            ...
            <div class="mu-our-teacher-content">
              <div class="row">
                <div class="col-lg-3 col-md-3  col-sm-6">
                  <div class="mu-our-teacher-single">
                    <figure class="mu-our-teacher-img">
                      <img src="<?=base_url('assets/img/teachers/teacher-01.png');?>" alt="teacher img">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6">
                  <div class="mu-our-teacher-single">
                    <figure class="mu-our-teacher-img">
                      <img src="<?=base_url('assets/img/teachers/teacher-02.png');?>" alt="teacher img">
                      <div class="mu-our-teacher-social">
                        <a href="#"><span class="fa fa-facebook"></span></a>
                        <a href="#"><span class="fa fa-twitter"></span></a>
                        <a href="#"><span class="fa fa-linkedin"></span></a>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6">
                  <div class="mu-our-teacher-single">
                    <figure class="mu-our-teacher-img">
                      <img src="<?=base_url('assets/img/teachers/teacher-03.png');?>" alt="teacher img">
                      <div class="mu-our-teacher-social">
                        <a href="#"><span class="fa fa-facebook"></span></a>
                        <a href="#"><span class="fa fa-twitter"></span></a>
                        <a href="#"><span class="fa fa-linkedin"></span></a>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6">
                  <div class="mu-our-teacher-single">
                    <figure class="mu-our-teacher-img">
                      <img src="<?=base_url('assets/img/teachers/teacher-04.png');?>" alt="teacher img">
                      <div class="mu-our-teacher-social">
                        <a href="#"><span class="fa fa-facebook"></span></a>
                        <a href="#"><span class="fa fa-twitter"></span></a>
                        <a href="#"><span class="fa fa-linkedin"></span></a>
            ...
            <div id="mu-testimonial-slide" class="mu-testimonial-content">
              ...
              <div class="mu-testimonial-item">
                ...
                <div class="mu-testimonial-img">
                  <img src="<?=base_url('assets/img/testimonial-1.png');?>" alt="img">
                </div>
              ...
              <div class="mu-testimonial-item">
                ...
                <div class="mu-testimonial-img">
                  <img src="<?=base_url('assets/img/testimonial-3.png');?>" alt="img">
                </div>
                <div class="mu-testimonial-info">
                  <h4>Rebaca Michel</h4>
              ...
              <div class="mu-testimonial-item">
                ...
                <div class="mu-testimonial-img">
                  <img src="<?=base_url('assets/img/testimonial-2.png');?>" alt="img">
                </div>
                <div class="mu-testimonial-info">
                  <h4>Stev Smith</h4>
                  <span>Happy Student</span>
                ...
                <div class="col-md-4 col-sm-4">
                  <article class="mu-blog-single-item">
                    <figure class="mu-blog-single-img">
                      <a href="#"><img src="<?=base_url('assets/img/blog/blog-1.jpg');?>" alt="img"></a>
