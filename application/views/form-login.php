...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>Committee</b>Manager</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <?=form_open('login/user',array('name' => 'login','id' => 'login'))?>
      <div class="form-group has-feedback">
        <?=form_input(array('name' => 'username','id' => 'username','type' => 'text','class' => 'form-control','placeholder' => 'Type username','value' => set_value('username')));?>
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
        <?=form_error('username','<div class="has-error"><span class="help-block">','</span></div>')?>
      </div>
      <div class="form-group has-feedback">
        <?=form_password(array('name' => 'password','id' => 'password','class' => 'form-control','placeholder' => 'Password','value' => set_value('password')));?>
...
<!-- Bootstrap 3.3.7 -->
<script src="<?=base_url('assets/bower_components/jquery/dist/bootstrap.min.js')?>"></script>
<!-- iCheck -->
