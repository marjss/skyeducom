...
class HtmlExcel {
    ...
    private $info = array();
    private $css;
    private $dnldwrkbookname = 'spreadsheet.xls';
    ...
    public function setWrkbookName($name){
        if(!empty($name)){
            $this->dnldwrkbookname = $name;
        }
    }
    ...
    public function headers(){
        ...
        header("Content-Disposition: attachment; filename=".$this->dnldwrkbookname);
    }
